...
:- nurse(N), minHoursPerYear(MIN), #sum{H,D : assign(N,T,D), workshift(T,_,H)} < MIN, N > 2.
...
group(assign(2,T,D), H, (D,2), (0, nurse(2), minHoursPerYear(MIN)), ge_amo) :-  nurse(2), assign(2,T,D), workshift(T,_,H), minHoursPerYear(MIN).
